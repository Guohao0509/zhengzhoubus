            ...
            controller: function($scope, $ionicPopup, $ionicPickerI18n, $timeout) {
                ...
                $scope.showPopup = function() {
                    $ionicPopup.show({
                        ...
                        title: $scope.title || ("选择 " + ($scope.dateEnabled ? "日期" : "") + ($scope.dateEnabled && $scope.timeEnabled ? " 和 " : "") + ($scope.timeEnabled ? "时间" : "")),
                ...
                var changeViewData = function() {
                    ...
                    if ($scope.timeEnabled) {
                        ...
                        $scope.meridiem = $scope.hour < 12 ? "上午" : "下午";
...
//                    };
            ...
            link: function($scope, $element, $attrs, ngModelCtrl) {
                $scope.title = "title" in $attrs && $attrs.title;
